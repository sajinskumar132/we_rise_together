      ...
      <div className="about_us_logo_container">
        ...
        <div className="about_us_sub_container_1">
          <p className="about_us_paragraphs">
            ...
            alone. Our platform is designed to connect individuals struggling
            with mental health challenges, providing a safe space for support,
          ...
          <p className="about_us_paragraphs">
            Our vision is to break the stigma surrounding mental health and
            build a world where support is just a click away. Whether you're
            seeking a listening ear, professional guidance, or a space to
            express yourself, we're here for you.
          </p>
        </div>
