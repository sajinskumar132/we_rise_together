  ...
  return (
    <div id="home" className="hero_main_container">
      <div className="hero_main_sub_container_1">
        ...
        <p className="hero_sub_headling">
          Struggling with depression? Find support, understanding, and a
          community that cares. "Together We Rise" connects you with people who
          truly listen, so you can share, heal, and grow—one step at a time.
        </p>
